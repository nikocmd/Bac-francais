...
export default function Paywall({
  ...
  description = "Tu as utilisé ton essai gratuit. Passe en Premium pour un accès illimité à toutes les fonctionnalités IA.",
}: Props) {
  return (
    <div className="bg-gradient-to-b from-[#FFD700]/5 to-[#0a1543]/80 border border-[#FFD700]/30 rounded-2xl p-8 text-center space-y-4 shadow-[0_0_30px_rgba(255,215,0,0.1)]">
      ...
      <p className="text-[#a0b0d0] text-sm max-w-sm mx-auto">{description}</p>
      <Link href="/premium"

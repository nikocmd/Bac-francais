...
export const metadata: Metadata = {
  ...
  keywords: [
    "simulation examen bac français",
    "jury bac français",
    "mode examen bac",
    "notation bac français",
    "barème bac français 2024",
    "BOEN bac français",
    "examen blanc bac français",
  ],
  alternates: { canonical: "https://bacfrancaisai.fr/examen" },
  openGraph: {
    title: "Simulation jury Bac de Français — BacFrançaisAI",
    description: "Jury IA officiel, barème BOEN 2024, notation sur 20 points. Entraîne-toi dans les vraies conditions.",

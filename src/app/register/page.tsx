      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="bg-[#0a1543]/80 border border-[#19327f] rounded-2xl p-6 space-y-4 shadow-[0_0_30px_rgba(25,50,127,0.3)] backdrop-blur">
          ...
          <button type="button" onClick={async () => {
            ...
            className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-[#19327f] bg-[#050a2e] hover:bg-[#0a1543] text-white font-bold text-sm transition-all">
